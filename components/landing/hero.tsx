        ...
        <div className="grid lg:grid-cols-2 gap-10 lg:gap-16 items-center">
          <div className="space-y-6 animate-fade-in">
            ...
            <div className="flex flex-wrap gap-2">
              {["AI Insights", "Kanban", "Pomodoro", "Team Sync"].map((f, i) => (
                <span
                  key={f}
                  className={cn(
                    "text-xs px-2.5 py-1 rounded-md bg-white/[0.03] border border-white/[0.06] text-gray-400 animate-fade-in",
                    `stagger-${i + 1}`
                  )}
                >
                  {f}
            ...
            <div className="flex flex-wrap gap-3 pt-1">
              <Button asChild className="bg-blue-600 hover:bg-blue-500 text-white rounded-lg px-6 h-10 text-sm shadow-lg shadow-blue-600/20 hover:shadow-blue-500/30 transition-shadow">
              ...
              <div className="flex -space-x-1.5">
                {["JD", "AK", "SM"].map((init, i) => (
                  <div
                    key={i}
                    className={cn(
                      "w-7 h-7 rounded-full border-2 border-black bg-gradient-to-br from-blue-500 to-violet-500 flex items-center justify-center text-[9px] font-semibold text-white animate-scale-in",
                      `stagger-${i + 1}`
                    )}
                  >
                    {init}
          ...
          <div className="relative animate-fade-in stagger-3">
            ...
            <div className="relative rounded-xl border border-white/[0.06] bg-white/[0.02] backdrop-blur-xl p-6 sm:p-7 hover:border-white/[0.12] transition-all duration-500">
              ...
              <div className="grid grid-cols-3 gap-2 mb-4">
                {[
                  ...
                  <div key={s.label} className={`${s.bg} rounded-lg p-2.5 text-center hover:scale-105 transition-transform`}>
              ...
              <div className="space-y-2">
                {[
                  ...
                  <div key={i} className="flex items-center gap-2.5 p-2 rounded-lg bg-white/[0.03] hover:bg-white/[0.05] transition-colors">
